...
function (e, t, a) {
        "use strict";
        var i,
            o = (i = a(0)) && i.__esModule ? i : { default: i };
        theme.FeaturedContentSection = function () {
            (0, o.default)(".rte").find("a:not(:has(img))").addClass("text-link");
        };
    },
    function (e, t, a) {
        "use strict";
        var i,
            o,
            n = (i = a(0)) && i.__esModule ? i : { default: i };
        function s(e) {
            var t = (this.$container = (0, n.default)(e)),
                a = (t.parent(), t.attr("data-section-id"));
            (this.slideshow = "#Slideshow-" + a), (this.namespace = "." + a);
            var i,
                s = (0, n.default)(e).find(".hero");
            s.length && theme.loadImageSection(s), this.init(), t.data("parallax") && ((i = { namespace: this.namespace }), (theme.parallaxSections[this.namespace] = new theme.Parallax(t.find(o), i)));
        }
        (theme.slideshows = {}),
            (theme.SlideshowSection =
                ((o = ".parallax-container"),
                (s.prototype = n.default.extend({}, s.prototype, {
                    init: function () {
                        this.onUnload();
                        var e = (0, n.default)(this.slideshow),
                            t = { autoplay: e.data("autoplay"), arrows: e.data("arrows"), dots: e.data("dots"), fade: !0, speed: 500 };
                    ...
                    onUnload: function () {
                        theme.parallaxSections[this.namespace] && (theme.parallaxSections[this.namespace].destroy(), delete theme.parallaxSections[this.namespace]),
                            theme.slideshows[this.slideshow] && (theme.slideshows[this.slideshow].destroy(), delete theme.slideshows[this.slideshow]);
                    },
                    onSelect: function () {
                        (0, n.default)(this.slideshow).slick("slickPause");
                    },
                    onDeselect: function () {
                        (0, n.default)(this.slideshow).slick("slickPlay");
                    },
                    onBlockSelect: function (e) {
                        var t = (0, n.default)(this.slideshow),
                            a = (0, n.default)(".slideshow__slide--" + e.detail.blockId + ":not(.slick-cloned)").data("slick-index");
...
function (e, t, a) {
        ...
        var i,
            ...
            d,
            u,
            h = (i = a(0)) && i.__esModule ? i : { default: i };
        function f(e) {
            var t = (this.$container = (0, h.default)(e)),
                a = ((this.sectionId = t.attr("data-section-id")), (this.youtubePlayerId = "YouTubeVideo-" + this.sectionId));
            this.namespace = "." + a;
            var i,
                o = (this.vimeoPlayerId = "Vimeo-" + this.sectionId),
                n = ((this.$vimeoTrigger = (0, h.default)("#VimeoTrigger-" + this.sectionId)), "Mp4Video-" + this.sectionId),
                s = (0, h.default)("#" + a),
                r = (0, h.default)("#" + o),
                l = (0, h.default)("#" + n);
            (this.vimeoPlayer = []),
                s.length && ((this.youtubeVideoId = s.data("video-id")), this.initYoutubeVideo()),
                r.length && ((this.vimeoVideoId = r.data("video-id")), this.initVimeoVideo()),
                l.length &&
                    (g(l),
                    (i = n),
                    document
        ...
        function m(e) {
            var t,
                a,
                i = "string" == typeof e ? e : !!e.data && e.data.id;
            i && (theme.isElementVisible((0, h.default)("#" + i)) ? s[(a = i)] && "function" == typeof s[a].playVideo && s[a].playVideo() : s[(t = i)] && "function" == typeof s[t].pauseVideo && s[t].pauseVideo());
        }
        function p(e) {
            e.closest(d.videoParent).addClass(u.loading);
        }
        function g(e) {
            e.closest(d.videoParent).removeClass(u.loading).addClass(u.loaded);
        }
        function v(e) {
            e.closest(d.videoParent).addClass(u.interactable), e.closest(d.promoContainer).addClass(u.interactable);
        }
        theme.VideoSection =
            ((c = {
                byline: (l = !(r = {
            ...
            (d = { videoParent: ".video-parent-section", promoContainer: ".promo-grid__container" }),
            (u = { loading: "loading", loaded: "loaded", interactable: "video-interactable" }),
            (f.prototype = h.default.extend({}, f.prototype, {
                initYoutubeVideo: function () {
                    (n[this.youtubePlayerId] = {
                        ...
                        events: {
                            onReady: function (e) {
                                var t, a, i, o;
                                (t = e),
                                    (a = this.youtubePlayerId),
                                    (o = (i = (0, h.default)("#" + a)).attr("id")),
                                    (s[o] = t.target),
                                    s[o],
                                    p(i),
                                    s[o].mute(),
                                    i.attr("tabindex", "-1"),
                                    m(o),
                                    (0, h.default)(window).on("scroll." + o, { id: o }, h.default.throttle(150, m));
                            }.bind(this),
                                ...
                                !(function (e, t) {
                                    ...
                                    switch (e.data) {
                                        ...
                                        case 1:
                                            ...
                                            break;
                                        case 3:
                                            n[i].attemptedToPlay = !0;
                                    }
                                })(e, this.youtubePlayerId);
                            }.bind(this),
                        },
                    }),
                        o ? this.loadYoutubeVideo() : (theme.LibraryLoader.load("youtubeSdk"), (0, h.default)("body").on("youTubeReady" + this.namespace, this.loadYoutubeVideo.bind(this)));
                },
                loadYoutubeVideo: function () {
                    var e = h.default.extend({}, r, n[this.youtubePlayerId]);
                    (e.playerVars.controls = 0), (s[this.youtubePlayerId] = new YT.Player(this.youtubePlayerId, e)), (o = !0);
                },
                initVimeoVideo: function () {
                    (n[this.vimeoPlayerId] = { divId: this.vimeoPlayerId, id: this.vimeoVideoId, type: "vimeo" }),
                        p((0, h.default)("#" + this.vimeoPlayerId)),
                        ...
                        l ? this.loadVimeoVideo() : (window.loadVimeo(), (0, h.default)("body").on("vimeoReady" + this.namespace, this.loadVimeoVideo.bind(this)));
                },
                loadVimeoVideo: function () {
                    var e = h.default.extend({}, c, n[this.vimeoPlayerId]);
                    (this.vimeoPlayer[this.vimeoPlayerId] = new Vimeo.Player(n[this.vimeoPlayerId].divId, e)), (l = !0), theme.config.bpSmall ? g((0, h.default)("#" + this.vimeoPlayerId)) : this.requestToPlayVimeoVideo(this.vimeoPlayerId);
                },
                ...
                playVimeoVideo: function (e) {
                    this.vimeoPlayer[e].play(), this.vimeoPlayer[e].setVolume(0), g((0, h.default)("#" + e));
                },
                onUnload: function (e) {
                    var t = e.target.id.replace("shopify-section-", "");
                    s["YouTubeVideo-" + t].destroy(), (0, h.default)(window).off("scroll" + this.namespace), (0, h.default)("body").off("vimeoReady" + this.namespace);
                },
            })),
            f);
    },
